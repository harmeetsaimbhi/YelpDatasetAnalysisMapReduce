...
public class MovielensGenreAvg extends Configured implements Tool
{
	...
	public int run(String[] args) throws Exception {
		...
		args = new String[] {"input_movielens", "output_question2"};
		...
		job.addCacheFile(new URI("file:///Users/Ishmeet/workspace/code/hadoop/movielens/ml-latest-small/movies.csv"));
